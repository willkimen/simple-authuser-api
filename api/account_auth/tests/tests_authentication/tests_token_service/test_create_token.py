...
from account_auth.authentication.token_service import create_token
from account_auth.models import ValidTokenModel
...
def test_token_persisted_in_database(
    ...
    create_token(id=payload["uid"], is_refresh=True)
