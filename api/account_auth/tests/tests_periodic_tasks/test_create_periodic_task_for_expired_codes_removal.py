...
from account_auth.constants.celery import REMOVE_EXPIRED_CODE_TASK_NAME
from account_auth.periodic_tasks import create_periodic_task_for_expired_codes_removal
