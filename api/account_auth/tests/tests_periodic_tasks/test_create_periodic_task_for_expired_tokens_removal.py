...
This test ensures that the `create_periodic_task_for_expired_tokens_removal` 
function correctly creates a periodic task in the database for removing expired tokens.
...
from account_auth.constants.celery import REMOVE_EXPIRED_TOKENS_TASK_NAME
