...
from account_auth.tasks import task_notify_activated_account
...
def test_task_notify_activated_account_success():
    ...
    result: EagerResult = task_notify_activated_account.apply(args=(EMAIL,))
...
def test_task_notify_activated_account_failure(
    ...
    mock_notify_activated_account: MagicMock,
):
    """
...
def test_task_data_is_recorded_when_it_fails(mock_notify_activated_account: MagicMock):
