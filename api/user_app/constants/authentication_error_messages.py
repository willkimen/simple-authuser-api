...
These messages are used to provide feedback when 
authentication fails due to issues with the Authorization header.
The purpose is to centralize all error messages related to 
JWT authentication in one place for easier management and consistency.
"""
