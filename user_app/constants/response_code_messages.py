...
VALIDATION_ERRORS = {
    ...
    "detail": "There are validation errors in the fields.",
}

ERROR_SENDING_EMAIL = {
    "code": "ERROR_SENDING_EMAIL",
    "detail": "A server error occurred while sending an email to the user.",
}

USER_REGISTERED_SUCCESSFULLY = {
    "code": "USER_REGISTERED_SUCCESSFULLY",
    "detail": "An email with the account confirmation code has been sent to the user's email.",
}

USER_NOT_FOUND = {
    "code": "USER_NOT_FOUND",
    "detail": "User not found in our database. Please check the user data.",
}
...
CODE_NOT_FOUND = {
    "code": "CODE_NOT_FOUND",
    "detail": "The code provided was not found.",
}

USER_HAS_ALREADY_ACTIVATED = {
    "code": "USER_HAS_ALREADY_ACTIVATED",
    "detail": "The user has already confirmed their email and is activated.",
}
...
ACTIVATED_USER = {
    "code": "USER_ACTIVATED",
    "detail": "The user's account was successfully activated.",
}

EMAIL_SEND_TO_USER_SUCCESSFULLY = {
    "code": "EMAIL_SEND_TO_USER_SUCCESSFULLY",
    "detail": "Email sent to the user successfully.",
}

USER_ACCOUNT_NOT_ACTIVATED = {
    "code": "USER_ACCOUNT_NOT_ACTIVATED",
    "detail": "The user's account is not activated.",
}

LOGOUT_SUCCESSFUL = {
    "code": "LOGOUT_SUCCESSFUL",
    "detail": "The user was successfully logged out, and the token was invalidated.",
}


LOGIN_SUCCESSFUL = {
    "code": "LOGIN_SUCCESSFUL",
    "detail": "The user was successfully logged in. An access and refresh token were returned.",
}

TOKEN_ACCESS_CREATED = {
    "code": "TOKEN_ACCESS_CREATED",
    "detail": "The access token was created successfully.",
}
...
IS_NOT_ACCESS_OR_REFRESH_TOKEN = {
    ...
    "detail": "The token sent is neither an access nor a refresh token.",
}
